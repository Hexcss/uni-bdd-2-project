...
const CreationModal: React.FC<IProps> = ({ open, onClose, subRoute }) => {
  ...
  function getContent() {
    ...
    switch (subRoute) {
      case "recipes":
        return <RecipeForm onClose={onClose} data={formData as IRecipe} id={id as string}/>;
      case "categories":
        return <CategoryForm onClose={onClose} data={formData as ICategory} id={id as string}/>;
      case "tags":
        return <TagForm onClose={onClose} data={formData as ITag} id={id as string}/>;
      default:
        return null;
    }
  }
